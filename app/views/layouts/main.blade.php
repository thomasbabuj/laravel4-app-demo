...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        {{ HTML::script('js/vendor/modernizer-2.6.2.min.js') }}
    </head>
    <body>
        <!--[if lt IE 7]>
            ...
            <header>
                ...
                <section id="action-bar">
                    ...
                    <nav class="dropdown">
                        <ul>
                            <li>
                                <a href="#">Shop by Category {{ HTML::image('img/down-arrow.gif', 'Show by Category') }}</a>
                                <ul>
                    ...
                    <div id="user-menu">
                        ...
                        <nav id="signin" class="dropdown">
                            <ul>
                                <li>
                                    <a href="#">{{ HTML::image('img/user-icon.gif', 'Sign In') }}Sign In {{ HTML::image('img/down-arrow.gif') }}</a>
                                    <ul>
                        ...
                        <nav class="dropdown">
                            <ul>
                                <li>
                                    <a href="#">{{ HTML::image('img/user-icon.gif', 'Thomas Babu') }} Thomas babu {{ HTML::image('img/down-arrow.gif', 'Thomas babu')}}</a>
                                    <ul>
            ...
            <footer>
                ...
                <section class="clearfix">
                    ...
                    <div id="payments">
                        ...
                        {{ HTML::image('img/payment-methods.gif', 'Support Payment Methods') }}
                    </div><!-- end payments -->
                </section>
            </footer>
        </div><!-- end wrapper -->
